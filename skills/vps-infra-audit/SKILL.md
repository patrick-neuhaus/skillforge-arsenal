...
description: "Pipeline de 3 agentes pra auditoria profunda de infraestrutura VPS. Audita, inspeciona, analisa, escaneia e avalia servidores. Revisa configuração Docker, verifica segurança de rede, checa resource limits, otimiza performance, planeja escalabilidade. Use esta skill SEMPRE que o usuário mencionar: VPS, servidor, infra, infraestrutura, 'como tá meu servidor', 'audit de infra', Docker Swarm, escalabilidade, 'meu servidor tá lento', 'preciso escalar', 'como configuro minha VPS', 'tá tudo no mesmo servidor', isolamento, multi-tenant, containers, hardening, 'meu servidor tá seguro?', server audit, infrastructure review, Docker audit, check my server, scan infrastructure, assess VPS, inspect server, optimize server, plan scaling. Diferente de security-audit: esta skill cobre INFRA (SO, Docker, rede, storage, recursos). security-audit cobre APLICAÇÃO (código, RLS, OWASP, autenticação). Se o contexto for segurança de aplicação, use security-audit."
---
