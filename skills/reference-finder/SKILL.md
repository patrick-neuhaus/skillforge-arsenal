...
description: "Fundamenta tema com referências consagradas — livros, frameworks, metodologias, pessoas, artigos. Use SEMPRE em: 'tem framework pra isso?', 'quem é referência?', 'tem livro sobre?', 'melhor prática pra X?', 'me fundamenta isso', 'preciso de referências', embasar decisão, aplicar conhecimento consagrado, best book for, who is the expert on, find best practices. Sugira quando user toma decisão importante sem referências. Consulte references/ primeiro. NÃO use pra perguntas técnicas diretas ('como configuro RLS' — responda direto), nem pra CONSTRUIR ferramenta própria (calculadora, tool no site → free-tool-strategy). Busca teoria, não implementação."
---
