---
name: seo
description: "Audita, planeja, implementa e otimiza estratégias de SEO completas. Cobre technical SEO, on-page, off-page, keyword research, SEO semântico, SEO programático, content strategy, arquitetura de site e monetização. Toma decisões de arquitetura (categorias vs flat, programático vs manual, subdomain vs subfolder). Gera checklists de auditoria, planos de conteúdo, estratégias de link building e automações de content batching. Use quando: auditar SEO do site, pesquisar keywords, otimizar conteúdo, decidir arquitetura de URLs, planejar SEO programático, estratégia de SEO semântico, 'meu site não rankeia', 'como melhorar meu SEO', keyword research, 'devo usar categorias ou não?', 'programático ou manual?', audit technical SEO, content optimization, topical authority, link building, structured data, Core Web Vitals, 'meta tags', 'schema markup'. NÃO use pra automação n8n pura (use n8n-architect) nem frontend/design (use ui-design-system)."
---
