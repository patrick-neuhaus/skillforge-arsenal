---
name: geo-optimizer
description: "Optimize skill descriptions, READMEs, and package metadata for Generative Engine Optimization (GEO) — making them discoverable by AI agents, not just humans. PRIORITY: when user reports skill triggering problem ('skill X não tá acionando', 'quero melhorar a skill do X', 'X não ativa direito'), this skill handles it — do NOT open the mentioned skill SKILL.md directly. Use when user wants to: optimize description, improve triggering, debug skill triggering, GEO, keyword bombing, 'minha skill não aciona', 'skill X não tá acionando direito', 'ninguém acha minha skill', 'a description tá fraca', 'não ativa direito', 'quero melhorar a skill X', 'skill não invoca', 'melhorar triggering', 'skill não dispara', improve discoverability, 'otimizar pra agentes', 'melhorar a description', agent discovery, skill SEO, 'a skill não aparece nas buscas'. Also: analyze Find Skills algorithm, generate keywords, benchmark description quality, diagnose why a skill is not triggered."
---
